...
(() => {
  ...
  function useCallEngine({ api, notify, selected, canUseCall, me, isNativeApp, sendSystemNotification }) {
  ...
  function isNativeRuntime() {
    var _a, _b, _c;
    try {
      return Boolean(window.Capacitor && ((_c = (_b = (_a = window.Capacitor).isNativePlatform) == null ? void 0 : _b.call(_a)) != null ? _c : true));
    } catch {
      return false;
    }
  }
  ...
  var ErrorBoundary = class extends React.Component {
    ...
    componentDidCatch(error) {
      showStartupOverlay("React render crashed", (error == null ? void 0 : error.stack) || String(error));
    }
    render() {
      if (this.state.hasError) {
        return /* @__PURE__ */ React.createElement("div", { style: { padding: 16 } }, /* @__PURE__ */ React.createElement("h2", null, "App failed to load"), /* @__PURE__ */ React.createElement("p", { className: "meta-line" }, "A startup error occurred. Please share a screenshot."));
      }
  ...
  if (isNativeRuntime()) {
    window.addEventListener("error", (e) => {
      const err = e == null ? void 0 : e.error;
      showStartupOverlay((e == null ? void 0 : e.message) || "Unhandled error", (err == null ? void 0 : err.stack) || String(err || ""));
    });
    window.addEventListener("unhandledrejection", (e) => {
      const reason = e == null ? void 0 : e.reason;
      showStartupOverlay("Unhandled promise rejection", (reason == null ? void 0 : reason.stack) || String(reason || ""));
    });
  }
  function App() {
    ...
    const [detailTab, setDetailTab] = useState2("chat");
    ...
    const nativeNotificationPlugin = (_b = (_a = window.Capacitor) == null ? void 0 : _a.Plugins) == null ? void 0 : _b.LocalNotifications;
    const nativeCallNotifications = (_d = (_c = window.Capacitor) == null ? void 0 : _c.Plugins) == null ? void 0 : _d.CallNotifications;
    ...
    }, [isNativeApp, me == null ? void 0 : me.role]);
    useEffect2(() => {
      window.scrollTo({ top: 0, behavior: "smooth" });
    }, [page, detailTab, selected == null ? void 0 : selected._id]);
    useEffect2(() => {
  ...
  try {
    ...
    showStartupOverlay("Fatal startup exception", (e == null ? void 0 : e.stack) || String(e));
  }
})();
